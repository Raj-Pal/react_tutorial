...
class App extends Component{
  ...
  onFormSubmit(data) {
    ...
    if(this.state.isEditProduct){
      apiUrl = 'localhost/react_tutorial/api/index.php/ReactApi/editProduct';
    } else {
      apiUrl = 'localhost/react_tutorial/api/index.php/ReactApi/createProduct';
    }
  ...
  editProduct = productId => {
    const apiUrl = 'localhost/react_tutorial/api/index.php/ReactApi/getProduct';
